/******************************************************************************
 * ESP32-P4-Nano WiFi Test - Without Display
 * Rocket Launcher System - WiFi Only Implementation for Testing
 * 
 * This version focuses on getting WiFi working first
 * Based on ESP32-P4-Nano documentation examples
 * 
...
static void system_monitor_task(void *pvParameters)
{
    while (1) {
        ...
        // Log status
        ESP_LOGI(TAG, "Status - WiFi:%s Safety:%s Fires:%lu",
