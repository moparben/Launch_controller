...
#include "nvs_flash.h"
// #include "serial_config.h"  // Disabled for testing
...
// JD9365 10.1" Waveshare display configuration (Original Waveshare Recommended)
// Using official Waveshare timing parameters - stable configuration
#define EXAMPLE_MIPI_DSI_DPI_CLK_MHZ  80
#define EXAMPLE_MIPI_DSI_LCD_H_RES    800
#define EXAMPLE_MIPI_DSI_LCD_V_RES    1280
#define EXAMPLE_MIPI_DSI_LCD_HSYNC    20   // hsync_pulse_width
#define EXAMPLE_MIPI_DSI_LCD_HBP      20   // hsync_back_porch  
#define EXAMPLE_MIPI_DSI_LCD_HFP      40   // hsync_front_porch
#define EXAMPLE_MIPI_DSI_LCD_VSYNC    4    // vsync_pulse_width
#define EXAMPLE_MIPI_DSI_LCD_VBP      10   // vsync_back_porch
#define EXAMPLE_MIPI_DSI_LCD_VFP      14   // vsync_front_porch
#endif

#define EXAMPLE_MIPI_DSI_LANE_NUM          2    // 2 data lanes
#define EXAMPLE_MIPI_DSI_LANE_BITRATE_MBPS 800  // 800Mbps - original Waveshare recommended
...
#define EXAMPLE_PIN_NUM_BK_LIGHT                27  // ESP32-P4-Nano backlight control (typical)
#define EXAMPLE_PIN_NUM_LCD_RST                 26  // ESP32-P4-Nano LCD reset (typical)
...
void app_main(void)
{
    ...
    // Initialize serial configuration toolkit (DISABLED FOR TESTING)
    // serial_config_init();
    // ESP_LOGI(TAG, "Serial configuration toolkit ready");
    ...
    size_t draw_buffer_sz = 800 * (1280 / 10) * sizeof(lv_color_t);
