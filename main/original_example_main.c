...
// These are the original Waveshare timing parameters from the ESP-IDF example
...
#define EXAMPLE_MIPI_DSI_LCD_VBP      10
#define EXAMPLE_MIPI_DSI_LCD_VFP      14

#define EXAMPLE_MIPI_DSI_LANE_NUM          2    // 2 data lanes
#define EXAMPLE_MIPI_DSI_LANE_BITRATE_MBPS 800 // 800 Mbps
...
void app_main(void)
{
    ...
    // Create a generic DPI panel directly without specific LCD controller driver
